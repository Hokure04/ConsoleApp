...
/**
 * Класс FileManager осуществляющий работу с файлом
 */
public class FileManager {
    ...
    /**
     * Конструктор создающий объект FileManager
     * @param filename1 имя первого файла
     * @param filename2 имя второго файла
     * @param coolM мэнеджер коллекции
     */
    public FileManager(String filename1, String filename2, CollectionManager coolM){
    ...
    /**
     * функция собирает все данные полученные после выполнения метода read() и обирает из них объект с типом MusicBand
     ...
     * @param collection колекция из объектов MusicBand
     * @throws IOException
     */
